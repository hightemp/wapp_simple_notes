...
<body onload="initDoc();">
    ...
    <form id="comp-form" name="compForm" method="post" action="" onsubmit="if(validateMode()){this.content.value=oDoc.innerHTML;return true;}return false;">
        ...
        <div id="toolbar">
            ...
            <div style="display:none">
                <span><input id="btn" type="submit" value="Сохранить" style="font-size:10px;"></span>
...
document.querySelector("#textBox").oninput = () => {
...
#comp-form {
    ...
    display: grid;
    grid-template-rows: calc(26px + 18px) 1fr;
}
